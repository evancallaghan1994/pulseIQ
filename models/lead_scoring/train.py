"""
Train the lead scoring XGBoost classifier.
...
from models.lead_scoring.features import load_features
...
def train():
    ...
    with mlflow.start_run():
        ...
        print(f"\nLead Scoring Model — {EXPERIMENT_NAME}")
        ...
        print(classification_report(y_test, y_pred, target_names=["not_converted", "converted"]))
        print("\nFeature Importances:")
